...
//contiene el c�digo HTML del mensaje
	...
	$libro=$_GET['titulo'];
	$asunto="devolución de ".$libro."";
	$cuerpo=utf8_decode("<h1>¡Confirmación de devolución!</h1>
	<p>
	  Estimado/a lector/a,
	</p>
	<p>
	  Queremos informarte que hemos recibido la devolución del libro que adquiriste en BookSell(".$libro."). Agradecemos que hayas disfrutado de la lectura y confiado en nosotros para tu experiencia literaria.
	</p>
	<p>
	  Esperamos que el libro haya cumplido tus expectativas y que hayas disfrutado de su contenido. Recuerda que siempre puedes explorar nuestra amplia selección de títulos para encontrar nuevas aventuras literarias.
	</p>
	<p>
	  Si tienes alguna pregunta o necesitas asistencia adicional, no dudes en ponerte en contacto con nuestro equipo de atención al cliente. Estamos aquí para ayudarte en todo lo que necesites.
	</p>
	<p>
	  ¡Gracias por ser parte de la comunidad de BookSell y esperamos volver a verte pronto en nuestra plataforma!
	</p>
	<p>
	  Saludos cordiales,
	  <br>
	...
	<html>
	  <head>
		<title>BookSell - Confirmación de devolución</title>
		<style>
		  body {
