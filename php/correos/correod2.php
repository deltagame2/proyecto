...
//contiene el c�digo HTML del mensaje
	...
	$libro=$_GET['titulo'];
	$asunto="Libro prestado";
	
	$cuerpo=utf8_decode("<h1>¡Se ha devuelto tu libro!</h1>
	<p>
	  Estimado/a prestador/a,
	</p>
	<p>
	  Queremos informarte que el libro que prestaste a través de BookSell( ".$libro." ) ha sido devuelto por el lector. Agradecemos tu participación en nuestra comunidad de lectores y tu disposición para compartir tus libros.
	</p>
	<p>
	  Esperamos que el lector haya disfrutado del libro y que haya sido una experiencia enriquecedora para ambos. Apreciamos tu contribución para fomentar la lectura y el intercambio de conocimientos.
	</p>
	<p>
	  Si tienes alguna pregunta o necesitas asistencia adicional, no dudes en ponerte en contacto con nuestro equipo de soporte. Estaremos encantados de ayudarte en todo lo que necesites.
	</p>
	<p>
	  ¡Gracias por ser parte de la comunidad de BookSell y por compartir tus libros con otros amantes de la lectura!
	</p>
	<p>
	  Saludos cordiales,
	  <br>
	...
	<html>
	  <head>
		<title>BookSell - Notificación de devolución</title>
		<style>
		  body {
