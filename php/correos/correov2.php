...
//contiene el c�digo HTML del mensaje
	...
	$cuerpo=utf8_decode("<h1>¡Has realizado una venta!</h1>
	<p>
	  Estimado/a vendedor/a,
	</p>
	<p>
	  Queremos felicitarte por tu éxito en BookSell. Nos complace informarte que has realizado una venta de uno de tus libros (".$libro.") y deseamos agradecerte por tu contribución a nuestra comunidad de lectores.
	</p>
	<p>
	  Te recordamos que ahora es el momento de preparar el envío del libro. Asegúrate de embalarlo de forma segura y utilizar un método de envío confiable. Recuerda proporcionar al comprador la información de seguimiento para que pueda rastrear su paquete.
	</p>
	<p>
	...
	<p>
	  ¡Gracias por ser parte de BookSell y por compartir tus libros con otros amantes de la lectura!
	</p>
	<p>
	  Saludos cordiales,
	  <br>
	...
	<html>
	  <head>
		<title>BookSell - Notificación de venta</title>
		<style>
		  body {
