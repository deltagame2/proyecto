...
//contiene el c�digo HTML del mensaje
	...
	$cuerpo=utf8_decode("<h1>¡Confirmación de compra!</h1>
	<p>
	  Estimado/a lector/a,
	</p>
	<p>
	  ¡Enhorabuena por tu compra en BookSell! Queremos informarte que tu transacción se ha realizado con éxito y agradecemos tu apoyo a la comunidad de lectores.
	</p>
	<p>
	  Hemos recibido tu pedido y nos pondremos manos a la obra para preparar el envío del libro que has adquirido(".$libro."). En breve, recibirás información sobre el envío y la fecha estimada de entrega.
	</p>
	<p>
	  Si tienes alguna pregunta o necesitas asistencia adicional, no dudes en ponerte en contacto con nuestro equipo de atención al cliente. Estamos aquí para ayudarte en lo que necesites.
	</p>
	<p>
	  ¡Disfruta de tu nueva adquisición y sumérgete en sus páginas llenas de aventuras y conocimiento!
	</p>
	<p>
	  Saludos cordiales,
	  <br>
	...
	<html>
	  <head>
		<title>BookSell - Confirmación de compra</title>
		<style>
		  body {
