...
//contiene el c�digo HTML del mensaje
	...
	$cuerpo=utf8_decode("<h1>¡Enhorabuena por pedir prestado ". $libro. "!</h1><p>Bienvenido/a a BookSell, tu destino literario. Estamos encantados de que hayas decidido sumergirte en el maravilloso mundo de la lectura y aprovechar nuestra amplia selección de libros.</p><p> Disfruta de tu libro prestado y déjate llevar por las páginas llenas de aventuras, emociones y conocimiento. Recuerda devolverlo a tiempo (tienes 30 dias naturales) para que otros lectores puedan disfrutarlo también.</p><p>Si tienes alguna pregunta o necesitas ayuda, nuestro equipo estará encantado de asistirte. ¡Que disfrutes de tu lectura!</p><p>Atentamente,<br> El equipo de BookSell :) ");
	$mensaje="<html><head><title>BookSell - Tu destino literario</title> <style>body { background-color: #f2f2f2;font-family: Arial, sans-serif;}.container {width: 600px; margin: 50px auto; background-color: #fff; padding: 20px;border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);}h1 {color: #333; text-align: center;}p { color: #555; line-height: 1.5;}img { display: block;margin: 0 auto;max-width: 200px; height: auto;}</style></head><body><div class='container'>".$cuerpo."</div></body></html>";
